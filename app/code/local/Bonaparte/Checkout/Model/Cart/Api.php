...
class Bonaparte_Checkout_Model_Cart_Api extends Bonaparte_Checkout_Model_Api_Resource
{
    ...
    public function createOrder($quoteId, $store = null, $agreements = null)
    {
        ...
        if ($quote->getCheckoutMethod() == Bonaparte_Checkout_Model_Api_Resource_Customer::MODE_GUEST
                && !Mage::helper('checkout')->isAllowedGuestCheckout($quote, $quote->getStoreId())) {
            $this->_fault('guest_checkout_is_not_enabled');
        }

        /** @var $customerResource Bonaparte_Checkout_Model_Api_Resource_Customer */
    ...
    public function licenseAgreement($quoteId, $store = null)
    {
        ...
        if (Mage::getStoreConfigFlag('checkout/options/enable_agreements')) {
            ...
            foreach ($agreementsCollection as $_a) {
                /** @var $_a  Bonaparte_Checkout_Model_Agreement */
