 ...
 */
class Bonaparte_Checkout_Model_Type_Multishipping extends Bonaparte_Checkout_Model_Type_Abstract
{
    /**
    ...
    protected function _init()
    {
        ...
        if ($this->getCheckoutSession()->getCheckoutState() === Bonaparte_Checkout_Model_Session::CHECKOUT_STATE_BEGIN) {
     ...
     * @throws  Bonaparte_Checkout_Exception
     */
    protected function _prepareOrder(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        foreach ($address->getAllItems() as $item) {
            ...
            if (!$_quoteItem) {
                throw new Bonaparte_Checkout_Exception(Mage::helper('checkout')->__('Item not found or already ordered'));
            }
    ...
    {
        $this->getCheckoutSession()->setCheckoutState(Bonaparte_Checkout_Model_Session::CHECKOUT_STATE_BEGIN);
        return $this;
    }
