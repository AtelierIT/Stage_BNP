 ...
 */
class Bonaparte_Checkout_Model_Api_Resource_Customer extends Bonaparte_Checkout_Model_Api_Resource
{
    /**
     ...
     */
     const MODE_CUSTOMER = Bonaparte_Checkout_Model_Type_Onepage::METHOD_CUSTOMER;
     const MODE_REGISTER = Bonaparte_Checkout_Model_Type_Onepage::METHOD_REGISTER;
     const MODE_GUEST    = Bonaparte_Checkout_Model_Type_Onepage::METHOD_GUEST;
     ...
     *
     * @param Mage_Sales_Model_Quote $quote
     * @return Bonaparte_Checkout_Model_Api_Resource_Customer
     */
