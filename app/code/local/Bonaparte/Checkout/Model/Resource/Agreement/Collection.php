 ...
 */
class Bonaparte_Checkout_Model_Resource_Agreement_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     * @return Bonaparte_Checkout_Model_Resource_Agreement_Collection
     */
