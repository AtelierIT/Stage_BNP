 ...
 */
class Bonaparte_Checkout_MultishippingController extends Bonaparte_Checkout_Controller_Action
{
    /**
     * Retrieve checkout model
     *
     * @return Bonaparte_Checkout_Model_Type_Multishipping
     */
     ...
     *
     * @return Bonaparte_Checkout_Model_Type_Multishipping_State
     */
     ...
     *
     * @return Bonaparte_Checkout_Helper_Url
     */
     ...
     *
     * @return Bonaparte_Checkout_Model_Session
     */
     ...
     *
     * @return Bonaparte_Checkout_MultishippingController
     */
    public function preDispatch()
    {
        ...
        if ($action == 'index') {
            ...
            $this->_getCheckoutSession()->setCheckoutState(
                Bonaparte_Checkout_Model_Session::CHECKOUT_STATE_BEGIN
            );
    ...
    public function addressesAction()
    {
        ...
        $this->_getState()->unsCompleteStep(
            Bonaparte_Checkout_Model_Type_Multishipping_State::STEP_SHIPPING
        );

        $this->_getState()->setActiveStep(
            Bonaparte_Checkout_Model_Type_Multishipping_State::STEP_SELECT_ADDRESSES
        );
    ...
    public function shippingAction()
    {
        ...
        if (!$this->_getState()->getCompleteStep(Bonaparte_Checkout_Model_Type_Multishipping_State::STEP_SELECT_ADDRESSES)) {
            $this->_redirect('*/*/addresses');
            return $this;
        }
    ...
    public function backToShippingAction()
    {
        ...
        $this->_getState()->unsCompleteStep(
            Bonaparte_Checkout_Model_Type_Multishipping_State::STEP_BILLING
        );
        $this->_redirect('*/*/shipping');
    }
    ...
    public function billingAction()
    {
        ...
        if (!$this->_getState()->getCompleteStep(Bonaparte_Checkout_Model_Type_Multishipping_State::STEP_SHIPPING)) {
            $this->_redirect('*/*/shipping');
            return $this;
        }
...
//            $this->_getState()->setActiveStep(
//                Bonaparte_Checkout_Model_Type_Multishipping_State::STEP_OVERVIEW
//            );
...
//    }
    ...
    public function overviewAction()
    {
        ...
        $this->_getState()->setActiveStep(Bonaparte_Checkout_Model_Type_Multishipping_State::STEP_OVERVIEW);
    ...
    public function overviewPostAction()
    {
        ...
        try {
            ...
            $this->_getState()->setActiveStep(
                Bonaparte_Checkout_Model_Type_Multishipping_State::STEP_SUCCESS
            );
            $this->_getState()->setCompleteStep(
                Bonaparte_Checkout_Model_Type_Multishipping_State::STEP_OVERVIEW
            );
            ...
            $this->_redirect('*/*/billing');
        } catch (Bonaparte_Checkout_Exception $e) {
    ...
    {
        if (!$this->_getState()->getCompleteStep(Bonaparte_Checkout_Model_Type_Multishipping_State::STEP_OVERVIEW)) {
            $this->_redirect('*/*/addresses');
            return $this;
        }
