 ...
 */
class Bonaparte_Checkout_Block_Cart_Item_Renderer_Configurable extends Bonaparte_Checkout_Block_Cart_Item_Renderer
{
        ...
        if($Sizetranslate != ''):
            foreach($options as $k=>$v){
                if($v['label'] == $labelSize){
                    $options[$k]['value'] = $Sizetranslate; // old value $options[$k]['value']
                }
            }
        endif;
