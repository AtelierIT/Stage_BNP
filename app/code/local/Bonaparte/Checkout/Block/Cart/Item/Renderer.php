 ...
 *
 * @method Bonaparte_Checkout_Block_Cart_Item_Renderer setProductName(string)
 * @method Bonaparte_Checkout_Block_Cart_Item_Renderer setDeleteUrl(string)
 */
class Bonaparte_Checkout_Block_Cart_Item_Renderer extends Mage_Core_Block_Template
{
    /** @var Bonaparte_Checkout_Model_Session */
     ...
     * @return  Bonaparte_Checkout_Block_Cart_Item_Renderer
     */
