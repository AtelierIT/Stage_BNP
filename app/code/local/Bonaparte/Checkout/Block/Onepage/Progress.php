 ...
 */
class Bonaparte_Checkout_Block_Onepage_Progress extends Bonaparte_Checkout_Block_Onepage_Abstract
{
     ...
     *  @see: Bonaparte_Checkout_Block_Onepage_Abstract::_getStepCodes() for allowed values
     * @return bool
     */
