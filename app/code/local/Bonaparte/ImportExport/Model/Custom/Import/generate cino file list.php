...
//    const PICTURE_BASE_PATH = '/var/www/bonaparte/magento/dump_files/pictures/';
     ...
     * @var string
     */
    const RESOURCES_BASE_PATH = '/dump_files/cino_files.csv';
    ...
    public function _construct()
    {
        ...
        foreach ($this->_configurationFilePath as $filePath) {
            ...
            $this->_data[$counter] = new Varien_Simplexml_Config($filePath);
            $this->_fileName[$counter]=$filePath;
            $counter++;
        }
...
//                }
//            }
            foreach ($productData['Items']['value'] as $item){
                        $fileName = explode("/", $this->_fileName[$counter]);
                     fputcsv($this->_fileHandlerResources,array($fileName[6],$item['CinoNumber']['value']));
            }
