 ...
 * Last Modified: 2013-05-21T13:30:55+02:00
...
class Xtento_OrderExport_Model_Export_Data_Shared_Items extends Xtento_OrderExport_Model_Export_Data_Abstract
{
    ...
    public function getExportData($entityType, $collectionItem)
    {
        ...
        foreach ($items as $item) {
            ...
            $taxItem = false;
            if ($entityType !== Xtento_OrderExport_Model_Export::ENTITY_ORDER && $entityType !== Xtento_OrderExport_Model_Export::ENTITY_QUOTE && $this->fieldLoadingRequired('order_item')) {
