...
Checkout.prototype = {
    initialize: function(accordion, urls){
        ...
        this.accordion.sections.each(function(section) {
            ...
            Event.observe($('upper-'+section.readAttribute('id')), 'click', this._onTopSectionClick.bindAsEventListener(this));
        }.bind(this));
    ...
    _onTopSectionClick: function(event) {
        ...
        if (section.hasClassName('allow')) {
            Event.stop(event);
            this.gotoSection(section.readAttribute('id').replace('upper-opc-', ''));
            return false;
        }
    },
    ...
    gotoSection: function(section)
    {
        ...
        var sectionElement = $('upper-opc-'+section);
        sectionElement.addClassName('allow');
    ...
    setBilling: function() {
        if (($('billing:use_for_shipping_yes')) && ($('billing:use_for_shipping_yes').checked)) {
            ...
            $('upper-opc-shipping').addClassName('allow');
    ...
    setStepResponse: function(response){
        ...
        if (response.allow_sections) {
            response.allow_sections.each(function(e){
                ...
                $('upper-opc-'+e).addClassName('allow');
            });
        }
