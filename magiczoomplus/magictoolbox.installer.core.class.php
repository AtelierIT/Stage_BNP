<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v4.7.13' || 'working' == 'v4.5.7') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoomplus&license=trial&tool_version=v4.5.7&module_version=v4.7.13&platform_name=magento&platform_version={$platformVersion}&url={$url}";
