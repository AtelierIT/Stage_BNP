...
if( ($fp = popen("php /home/stagebon/stage.bonaparteshop.com/html/exportEnabled.php", "r")) ) {
echo $bs.$bs."Running the enabled product export function".$bs;
while( !feof($fp) ){
        echo fread($fp, 1024);
        echo $bs;
        flush(); // you have to flush buffer
...
<form method="get">
<button type="submit">MoveEnabledToLive</button>
