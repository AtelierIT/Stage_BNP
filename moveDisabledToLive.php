...
if( ($fp = popen("php /home/stagebon/stage.bonaparteshop.com/html/cron.php", "r")) ) {
...
if( ($fp = popen("php /home/stagebon/stage.bonaparteshop.com/html/exportDisabled.php", "r")) ) {
echo $bs.$bs."Running the disabled product export function".$bs;
while( !feof($fp) ){
        echo fread($fp, 1024);
        echo $bs;
        flush(); // you have to flush buffer
...
<form method="get">
<button type="submit">MoveDisabledToLive</button>
